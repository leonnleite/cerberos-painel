...
namespace br\com\cf\library\core\model;

use br\com\cf\library\core\connection\Connection;
...
abstract class ModelAbstract {
    ...
    protected function __construct($entry = NULL) {
        ...
        $this->_conn = Connection::factory($entry)->getConnection();
        $this->_check();
    ...
    public function insert($object) {
        ...
        try {
            ...
            $stmt = $this->_conn->prepare(sprintf('insert into %s (%s) values (%s)', $this->_entity, implode(',', $fields), implode(',', $jokers)));
    ...
    public function findByParam($object) {
        ...
        try {
            ...
            $stmt = $this->_conn->prepare(sprintf('select %s from %s where %s', implode(',', $columns), $this->_entity, implode('and', $where)));
