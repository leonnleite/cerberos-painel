...
drop table if exists campeonato_x_usuario;
...
drop table if exists grupo_x_usuario;

drop table if exists jogador;

drop table if exists jogador_proprietario;

drop table if exists jogo;

drop table if exists jogo_comentario;

drop table if exists jogo_resultado;

drop table if exists jogo_resultado_status;

drop table if exists jogo_status;

drop table if exists lance;

drop table if exists leilao;

drop table if exists leilao_status;
...
drop table if exists temporada_status;
...
drop table if exists usuario_x_serie_x_temporada;
